(function() {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    if (accumulator === undefined) {
      ...
      _.each(collection, function(value, index, items) {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(memo, value) {
      ...
      return memo = Boolean(iterator(value));
    }, true);
  ...
  _.some = function(collection, iterator) {
    ...
    return !_.every(collection, function(value, index, collection) {
  ...
  _.extend = function(obj) {
    // iterating over arguments (objects)
  ...
  _.memoize = function(func) {
    ...
    const inner = function() {
      ...
      if (memo[stringified] !== undefined) {
        return memo[func];        
      } else {
        return memo[stringified] = func(...arguments);
      }
    };
